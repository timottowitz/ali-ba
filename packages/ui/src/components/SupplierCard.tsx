...
export function SupplierCard({ supplier, whySnippet }: SupplierCardProps) {
  return (
      ...
      <div className="p-6">
        <div className="flex items-start space-x-4 mb-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center space-x-2 mt-1">
              ...
              {(supplier.verificationStatus === 'verified' || supplier.verificationStatus === 'gold_verified') && (
        ...
        <div className="mt-4 pt-4 border-t relative">
          {whySnippet && (
            <span
              title={whySnippet}
              className="absolute -top-3 right-0 inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium bg-yellow-50 text-yellow-800 border border-yellow-200 cursor-help"
            >
              Why?
            </span>
          )}
