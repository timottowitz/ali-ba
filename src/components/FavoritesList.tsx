          ...
          <div key={favorite._id} className="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow">
              ...
              <div className="aspect-square bg-gray-100 rounded-t-lg overflow-hidden">
                {favorite.product.imageUrls?.[0] ? (
                  <img
                    ...
                    alt={(favorite.product as any).title?.en || (favorite.product as any).name || 'Product'}
            ...
            <div className="p-4">
              <h3 className="font-medium text-gray-900 mb-2 line-clamp-2">
                {(favorite.product as any).title?.en || (favorite.product as any).name || 'Product'}
              </h3>
              <div className="text-lg font-semibold text-orange-600 mb-2">
                ${(favorite.product as any).pricingTiers?.[0]?.price?.toFixed(2) || (favorite.product as any).price?.min?.toFixed(2) || '0.00'}
              </div>
              ...
              <div className="flex items-center justify-between text-sm text-gray-500">
                ...
                <span>{favorite.product.supplier?.location}</span>
              </div>
